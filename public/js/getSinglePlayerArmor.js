document.addEventListener("DOMContentLoaded", function () {
    ...
    const callbackForPlayerArmor = (responseStatus, responseData) => {
      ...
      armorList.forEach((playerE) => {
        ...
        displayItem.innerHTML = `
          ...
          <img src="equipment/${playerE.id}.png" class="card-img-top" alt="Equipment Image">
            ...
            `;
        playerArmor.appendChild(displayItem);
      });
    };
  
    fetchMethod(currentUrl + `/api/player/${playerId}/armor`, callbackForPlayerArmor);
  });
