      ...
      <div class="d-flex align-items-center">
        <img src="${classImageSrc}" alt="${responseData.class}" 
            ...
            <div class="d-flex justify-content-between">
                ...
                <small><strong>UserID:</strong> ${responseData.user_id}</small>
            </div>
            ...
            <div class="d-flex justify-content-between">
                <small><strong>Armor ID:</strong> ${responseData.armor_id}</small>
                <small><strong>Weapon ID:</strong> ${responseData.weapon_id}</small>
            </div>
