      ...
      responseData.forEach((review) => {
        ...
        editButton.addEventListener("click", () => {
          ...
          if (newRating !== null && newReview !== null) {
            ...
            const url = `${currentUrl}/api/challenges/${challengeId}/review/${review.review_id}`;
            const data = { 
              rating: newRating,
              review: newReview
            };
        ...
        deleteButton.addEventListener("click", (event) => {
          ...
          if (confirm("Are you sure you want to delete this review?")) {
            ...
            fetchMethod(currentUrl + `/api/challenges/${challengeId}/review/${review.review_id}`, callbackForDelete, 'DELETE', null, localStorage.getItem("token"));
          }
        });
      });
    };
  
    fetchMethod(currentUrl + `/api/challenges/${challengeId}/review`, callback);
  });
